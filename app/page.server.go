...
var landingFeatures = []map[string]any{
	...
	{"tok": "5.48×", "ttl": "Honest full-parse cost", "body": "Full parses run 5.48× C by equal-fixture geomean against a locked upstream-C oracle — slower, measured, not a marketing number. Fleet ratios and caveats are published per language.", "color": "c-green"},
