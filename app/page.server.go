...
var landingFeatures = []map[string]any{
	...
	{"tok": "5.53×", "ttl": "Honest full-parse cost", "body": "Production full parses run 5.526× C by equal-fixture geomean against a locked upstream-C oracle — slower, measured, not a marketing number. The separate compact diagnostic lane measures 2.9975× C.", "color": "c-green"},
