...
var landingFeatures = []map[string]any{
	...
	{"tok": "4.85×", "ttl": "Honest full-parse cost", "body": "Full parses run 4.851050× C by equal-fixture geomean against a locked upstream-C oracle — slower, measured, not a marketing number. Fleet ratios and caveats are published per language.", "color": "c-green"},
